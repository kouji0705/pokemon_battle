...
func (b *Battle) Start() string {
	for {
		...
		println(b.Pokemon1.Name, "used", move.Name, "and dealt", damage, "damage!")
		if b.Pokemon2.IsFainted() {
			return b.Pokemon1.Name + " wins!"
		}

		// ポケモン2のターン
		move = b.Pokemon2.Moves[0] // 同様に、最初の技を使用
		damage, _ = b.Pokemon2.AttackPokemon(b.Pokemon1, move)
		println(b.Pokemon2.Name, "used", move.Name, "and dealt", damage, "damage!")
		if b.Pokemon1.IsFainted() {
			return b.Pokemon2.Name + " wins!"
		}
	}
}
